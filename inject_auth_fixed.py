...
# Hardcoded correctly this time without dynamic Python f-string errors getting written to JSON
new_source = [
    "try:\n",
    "    import google.colab\n",
    "    IN_COLAB = True\n",
...
for cell in nb['cells']:
    if cell['cell_type'] == 'code' and 'source' in cell:
        ...
        # Check if it's the colab init block
...
print("Notebook auth injected correctly.")
